        ...
        <Modal id="modalGoogleForm" isOpen={modals["modalGoogleForm"]} setIsOpen={handleModal}>
            ...
            <FormGoogle
                inputs={[
                    ...
                    {
                        type: 'text', placeholder: 'Instagram', name: 'instagram', required: true,
                    }, {
                        type: 'email', placeholder: 'Your Email', name: 'email', required: true,
                    }, {
                        type: 'radio',
                        placeholder: 'form_tags',
                        name: 'form_tags',
                        required: true,
                        options: [{value: 'fan', label: 'I’m a Fan'}, {value: 'model', label: 'I’m a Model'},],
                    },]}
